# 🔌 Especificação da API REST — saude-monitor v2.2
...
> | **Data** | 07/08/2026 (última atualização: 12/09/2026) |
> | **Base** | Árvore Tecnológica v2.1 (ADRs) · Documento Negocial v2.0 (RN) · Backlog v2.1 (Fase 0 + E1–E8) |

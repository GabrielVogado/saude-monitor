...
> | **Skills usadas** | Repositório [kursku/skills](https://github.com/kursku/skills) — as 10 escolhidas estão copiadas em `.claude/skills/` (ver §9) |
...
**Objetivo:** 30 a 50 pessoas usando de verdade; descobrir o que quebra e o que confunde. Corresponde à sprint S12.
...
Das ~1.850 skills do repositório [kursku/skills](https://github.com/kursku/skills), estas 10 são as que servem para um app gratuito, de saúde, local e em pré-lançamento. Todas estão em `.claude/skills/<nome>/SKILL.md` neste repositório, então o Claude Code as carrega sozinho quando você abrir o projeto. Para usar no claude.ai, faça upload do `SKILL.md` em **Personalizar → Habilidades**.
...
Estou chamando umas 40 pessoas de confiança para testar antes de
...
2. **Semanas 3–6:** 30–50 conhecidos testando; conversar com eles toda semana; só avançar com **3 hospitais com N ≥ 5**.

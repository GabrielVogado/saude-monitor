...
| ID Backlog | Estória | Feature(s) Relacionada(s) | Status Implementação |
|---|---|---|---|
| **E8-01** | Eliminar cold start na primeira abertura | Cross | 🟡 Em andamento — **P0**, medido em 109 s com HTTP 503. Decisão do PO em 02/09/2026: sair do Render `plan: free` para uma VM **Oracle Cloud Always Free** (Ampere A1, São Paulo, mesma praça do Atlas `sa-east-1`). Artefatos de deploy em `deploy/oracle/`; virada pendente de medição comparativa e de **E8-16** |

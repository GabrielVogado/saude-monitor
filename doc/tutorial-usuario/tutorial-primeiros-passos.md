...
![Tela inicial do app, explicando detecção automática, feedback rápido e avaliação pública](imagens/01-inicio.png)
...
![Tela de Perfil com os botões Entrar e Criar conta](imagens/11-perfil.png)

Preencha seu nome, e-mail e uma senha (o telefone é opcional) e aceite os Termos de
Uso e a Política de Privacidade.

![Formulário de cadastro com nome, e-mail, telefone e senha](imagens/05-cadastro.png)
...
![Tela de login com e-mail, senha e opção "Lembrar este dispositivo"](imagens/06-login.png)
...
![Tela de recuperação de senha por e-mail](imagens/07-esqueci-senha.png)
...
![Lista de hospitais com filtros por tipo](imagens/02-hospitais-lista.png)

Use o campo de busca para encontrar um hospital pelo nome:

![Busca por "hran" filtrando para o Hospital Regional da Asa Norte](imagens/03-hospitais-busca.png)
...
![Detalhe do Hospital de Base do Distrito Federal, com mapa e endereço](imagens/04-hospital-detalhe.png)
...
![Ranking de hospitais ordenado pela melhor nota](imagens/09-ranking.png)
...
![Mapa com dezenas de hospitais de Brasília marcados](imagens/08-mapa.png)
